                ...
                <div class="topnav">
                    <nav class="container">
                        ...
                        <ul id="menu" style="display: none;">
                            ...
                            <cfif checkPermission("service_statistics") && !isNull(session.user.id)>
                                <li><a href="/manager/servicestats" class="">Service Statistics</a></li>
                            </cfif>

                            #generateMenu(true)#

                            <cfif isNull(session.user.id)>
                                <li class="pull-right"><a href="/manager" class="">Login</a></li>
                            <cfelse>
                                <li class="pull-right"><a href="/manager/users/logout" class="">Logout</a></li>
                            </cfif>
                        </ul>
                        </div>
                    </nav>
